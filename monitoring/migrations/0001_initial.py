    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_launch', models.DateTimeField(default=monitoring.models.default_last_launch, verbose_name='last_launch')),
                ('next_launch', models.DateTimeField(default=datetime.datetime.now, verbose_name='next_launch')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(default='Dodja', max_length=255, verbose_name='subject')),
                ('date_expire', models.DateTimeField(default=monitoring.models.default_date_expire, verbose_name='date_created')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='date_created')),
                ('users', models.ManyToManyField(related_name='html_notifications', to=settings.AUTH_USER_MODEL, verbose_name='user')),
            ],
        ),
    ]
